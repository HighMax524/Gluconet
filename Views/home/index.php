...
<head>
    ...
    <!-- Existing Styles -->
    <link rel="stylesheet" href="<?= BASE_URL ?>/css/nav_bar.css">
    <!-- New Premium Styles -->
...
<body>
    ...
    <section class="hero">
        ...
        <div class="hero-actions">
            <a href="<?= BASE_URL ?>/auth/login" class="btn btn-primary">Se connecter</a>
            <a href="<?= BASE_URL ?>/auth/register" class="btn btn-secondary">Créer un compte</a>
        </div>
    </section>
