...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="<?= BASE_URL ?>/css/css_role.css">
    <title>Role</title>
</head>
<body>
<div class="role_form">
    ...
    <div class="form_role_container">
        <form id="form_inscr" action="" method="post">
            <label for="role_patient" class="role-option" style="display:inline-flex;flex-direction:column;align-items:center;margin:0 12px;">
                <input id="role_patient" type="radio" name="role" value="patient" required>
                <img src="<?= BASE_URL ?>/img/patient.png" alt="patient">
                <span style="margin-top:8px; text-align:center; display:block;">Patient</span>
            </label>

            <label for="role_medecin" class="role-option" style="display:inline-flex;flex-direction:column;align-items:center;margin:0 12px;">
                <input id="role_medecin" type="radio" name="role" value="medecin">
                <img src="<?= BASE_URL ?>/img/medecin.png" alt="médecin">
